...
import { Container, Header, Button, Grid, Icon, Message, Segment, Menu, Input, Label } from 'semantic-ui-react';
...
class MainLayout extends Component {
  ...
  render() {
    /*
    <div>
      <Header as='h1' style={{ position: 'fixed' }}>CC Tutor</Header>
      <div className='ui massive vertical left fixed menu'
        style={{
          position: 'fixed',
          top: 50, left: 0, bottom: 0,
          width: 250,
          background: '#eaeaea', //'rgb(27, 28, 29)',
          overflowY: 'auto'
        }}>
